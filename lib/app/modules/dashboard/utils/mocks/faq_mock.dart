...
var faqMock = <Faq>[
  ...
  Faq(
      ...
      response:
          'Clicando na atividade, você será direcionado para a tela de mais informações, onde encontrará um botão para validação de presença. Ao seleciona-lo, você deve preencher um token com 6 dígitos, que será fornecido pelo professor responsável pela atividade. Lembrando que o botão de validação só estará disponível caso você esteja inscrito na atividade. Qualquer problema com o token informe o professor responsável imediatamente.'),
  Faq(
  ...
  Faq(
      ...
      response:
          'Os certificados serão disponibilizados automáticamente no seu perfil 10 dias após o evento. Caso ocorra algum erro, entre em contato com nosso suporte: antendimento.smile@maua.br.'),
  Faq(
      question: 'Como alterar meu nome/nome social para a certificação?',
      response:
          'Ao entrar na aba de perfil, você poderá alterar alguns de seus dados clicando no lápis no canto superior direito. A data limite para troca de nomes antes da emissão do certificado é de 5 dias após o término do evento (02/06/2023).'),
  Faq(
      question:
