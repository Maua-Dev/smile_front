...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m3(benefit) => "${Intl.select(benefit, {
            ...
            'eight':
                'Insertion of the sponsor\'s folder or gift in the event bag.',
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "registerEmailProfessorConfirmationPlaceholder":
            MessageLookupByLibrary.simpleMessage("Confirm your e-mail Mauá"),
        ...
        "sendEmailToAllEnrolls":
            MessageLookupByLibrary.simpleMessage("Send email to all"),
        "sendEmailToSomeone":
